...
export default function ReportShellLayout({ children }: { children: React.ReactNode }) {
  return (
    <>
      <header
        ...
        style={{
          ...
          viewTransitionName: 'report-header',
        }}
      >
        <div className="flex items-center px-4.5">
          ...
          <h1 className="text-ink-900 flex-1 text-center text-base font-bold">리포트</h1>
